...
/**
 * Hacky noncoremod way of being able to display fakeAchievements
 * @author James
 *
 */
public class EnhancedGuiAchievement extends GuiAchievement{
    ...
    public EnhancedGuiAchievement(Minecraft par1Minecraft)
    {
    	super(par1Minecraft);
     ...
     * Queue a taken achievement to be displayed.
     */
    public void queueFakeAchievement(FakeAchievement par1Achievement)
    {
        this.achievementGetLocalText = par1Achievement.getName();
    ...
    public void updateAchievementWindow()
    {
        if (this.theAchievement != null && this.achievementTime != 0L)
        {
            ...
            else
            {
                ...
                if (this.haveAchiement && (theAchievement instanceof FakeAchievement == false))
                {
